...
## Timeline of hospital care in the U.S.
...
- Must understand hospital markets and hospital pricing if we want to address health care spending
...
- Recall the high spending on health care in US relative to other countries. [Health System Tracker](https://www.healthsystemtracker.org/brief/what-drives-health-spending-in-the-u-s-compared-to-other-countries/#Healthcare%20spending%20per%20capita,%20by%20spending%20category,%202021)
...
## Role of price transparency {.today-cue data-cue="Launch poll: posted prices, what happens?"}

- How does the lack of price transparency impact patient behavior and health care costs?
- Would making hospital prices more transparent reduce health care spending, or would it lead to unintended consequences?
...
- This could play out in health care as well, but it's not guaranteed

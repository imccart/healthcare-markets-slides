...
- Common measure is Herfindahl-Hirschman Index (HHI), $\sum_{i=1}^{N} s_{i}^{2}$.
  ...
  - 1,500 to 2,500 is considered **moderately concentrated**
...
## Types of hospitals involved in mergers {.today-cue data-cue="Launch poll: merger, what happens to prices?"}

...
- Significant reduction in prices, over 70% reduction from brand-name price after a few years
...
- Biologics are drugs made from living organisms
  ...
  - Longer regulatory data exclusivity after coming to market (12 years versus 5 years)
...
- Distribution of generic drugs remains subject to market power of pharmacy benefit managers (PBMs)
  ...
  - PBM market dominated by just a few firms (Express Scripts, CVS Caremark, and OptumRx)
...
- Allergan sold its drug to the Saint Regis Mohawk Tribe
  - Licensed drug back to Allergan
...
What should Questcor do and how?
...
- Bidding from a more advantageous position (maintaining monopoly power) versus competing to become a duopolist

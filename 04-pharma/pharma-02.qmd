...
$$\frac{p^{*}_{c}}{p^{*}_{nc}} = \frac{\frac{1}{2} (\frac{a}{\alpha}+c)}{\frac{a+c}{2}} = \frac{a+\alpha c}{\alpha(a+c)} > 1$$

- Equal to $\frac{1}{\alpha}$ when marginal cost $c=0$
...
- Specialty drugs more likely to be unique, with few close substitutes
...
**Firm 1:** $$p_{1}^*(p_{2}) = \frac{a + cp_{2} + b\,mc_{1}}{2b}$$
**Firm 2:** $$p_{2}^*(p_{1}) = \frac{a + cp_{1} + b\,mc_{2}}{2b}$$
...
1. **Stage 1:** Insurer chooses one drug with a copayment to be on formulary. Other drug will not be covered at all

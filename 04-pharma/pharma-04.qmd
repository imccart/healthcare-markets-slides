...
## Kremer–Snyder: Visualizing Revenues

::: {layout="[[-1], [1], [-1]]"}
![](../figures/kremer_snyder_grid.png){fig-align="center" width="60%"}
:::

- High-risk patients generate relatively high revenue from both prevention and treatment
- Low-risk patients are hard to monetize with prevention, even when prevention is socially valuable
- Private R\&D may tilt toward treatments, even if prevention yields higher social surplus
...
- Empirically, cancer R&D is heavily concentrated in late-stage and recurrent disease,
  with far fewer trials on prevention or very early-stage disease
...
## Cancer Trials by Stage (Stylized)

::: {layout="[[-1], [1], [-1]]"}
![](../figures/cancer_trials_by_stage.png){fig-align="center" width="60%"}
:::

- Trials are heavily concentrated in metastatic and recurrent disease
- Far fewer trials focus on prevention or very early-stage disease
- Suggests underinvestment in long-horizon, prevention-oriented projects

...
::: {layout="[[-1], [1], [-1]]"}
![](../figures/mei_cost_of_capital.png){fig-align="center"}
:::
...
::: {layout="[[-1], [1], [-1]]"}
![](../figures/kremer_snyder_grid.png){fig-align="center"}
:::
...
::: {layout="[[-1], [1], [-1]]"}
![](../figures/cancer_trials_by_stage.png){fig-align="center"}
:::
...
::: {layout="[[-1], [1], [-1]]"}
![](../figures/pbm_flow_diagram.png){fig-align="center"}
:::
...
::: {layout="[[-1], [1], [-1]]"}
![](../figures/global_pharma_sales_regions.png){fig-align="center"}
:::

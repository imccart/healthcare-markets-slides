...
- Physicians face very different incentives under fee-for-service versus capitation  
- These incentives help explain variation in treatment intensity across systems  
- Understanding these models is key to understanding U.S. reforms like ACOs, bundled payments, and value-based contracts  


## Roadmap

1. Fee-for-Service vs. Capitation  
2. Agency Model and Predictions  
3. Beyond FFS and Capitation: Hybrids and Pay-for-Performance  
4. Physician Agency in Practice 
...
## Capitated Payments {.today-cue data-cue="Launch poll: capitation, more care or less?"}
...
::: {.fragment}
**The Takeaway**: On the margin, financial incentives *do* affect treatment decisions. Some responses may negatively affect patients, but this typically involves more money for similar-quality care.
:::

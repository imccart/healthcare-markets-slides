...
Health insurance isn’t a standard market: the buyer is often an employer or the government, and the product bundles risk pooling, networks, and admin services. This raises the question, do we want to rely on standard market-based competition for health insurance?
...
Curto et al. (2021) study the MA market in detail:
...
**In short,** Whether we *want* competition depends less on theory and more on how well policy design channels insurer incentives toward efficiency, equity, and fiscal sustainability.

...
- Expected wealth is: $E[w] =$ `r format(ewealth, digits=5, big.mark=",")`
...
- Since the person starts with \$100,000, the full WTP for health insurance is \$100,000 $-$ \$`r format(inv.u,digits=5,big.mark=",")` $=$ \$`r format(wtp,digits=5,big.mark=",")`, which is also the sum of the actuarially fair premium of \$`r format(ecost,digits=5,big.mark=",")` and the risk premium of \$`r format(wtp-ecost,digits=5,big.mark=",")`.
...
## What affects the risk premium? {.today-cue data-cue="Launch poll: what would you pay to insure a coin flip?"}

...
- Risk aversion gives us a **willing buyer** who will pay more than expected cost
- But an insurance market needs more than a willing buyer

::: {.fragment}
The risk itself has to have the right features.
:::


## Five conditions

1. The loss is **random**, not chosen
2. The probability is **estimable**, so the insurer can price it
3. Risks are roughly **independent** across people, so the pool averages out
4. The loss is **large** relative to the premium, so the overhead is worth paying
5. The loss is **verifiable**


## Does health insurance qualify?

Health insurance strains several of these:

- Much care is partly **chosen**, not purely random (checkups, treatment choices)
- You often know more about your health than the insurer does
- Lots of spending is **small and routine**, yet covered anyway

::: {.fragment}
These failures are a big part of why the market looks the way it does. More on this next time.
:::
